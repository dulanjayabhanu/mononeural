...
export function FooterSimple({
  companyName = "MonoNeural",
  description = "Build, Train & Test Artificial Neurons Visually",
  links = {
    product: [
      { name: "Artificial Neuron Trainer", url: "/trainer" },
      { name: "Artificial Neuron Tester", url: "/tester" },
      { name: "Pre-Trained Examples", url: "/examples" },
  ...
  social = {
    twitter: "https://x.com/DulanjayaBhanu",
    github: "https://github.com/dulanjayabhanu/mononeural",
  },
  copyright = `© ${new Date().getFullYear()} MonoNeural.`,
}: FooterSimpleProps) {
  return (
    <footer className="border-border border-t bg-background">
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
        >
          <p className="text-foreground/60 text-sm">{copyright} Built By <a
              href="https://github.com/dulanjayabhanu"
              target="_blank"
              rel="noopener noreferrer"
              className="font-semibold underline underline-offset-4 decoration-2 text-foreground hover:text-muted-foreground transition-all duration-300"
          >Dulanja Bhanu</a>
          </p>
        </motion.div>
      </div>
