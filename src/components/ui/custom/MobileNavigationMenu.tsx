import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuGroup, DropdownMenuItem, DropdownMenuLabel, DropdownMenuPortal, DropdownMenuSeparator, DropdownMenuSub,
...
const MobileNavigationMenu = () => {
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent className="w-55 p-4 m-4 border" align="start">
                <DropdownMenuGroup>
                    <DropdownMenuItem
                        onClick={() =>
                            navigate("/")
